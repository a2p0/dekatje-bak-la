...
RSpec.describe "Parcours tuteur complet (E2E)", type: :feature, tutor_streaming: true do
  ...
  scenario "persistance : rouvrir le drawer conserve les messages précédents", js: true do
    ...
    create(:message, conversation: conv, role: :user,      content: "Premier message élève", question_id: question.id)
    create(:message, conversation: conv, role: :assistant, content: "Réponse du tuteur",      question_id: question.id)
